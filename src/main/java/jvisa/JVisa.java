...
Copyright 2014-2016 Günter Fuchs
...
public class JVisa {
  ...
  public static final String JVISA_VERSION = "JVisa Version 0.5";
  ...
  */
  ...
  public static VisaLibrary visaLib;
    ...
    try {
      ...
      if (OS_NAME.contains("win")) {
        ...
        try {
          ...
          visaLib = (VisaLibrary) Native.loadLibrary(visaLibName, VisaLibrary.class);
        }
        ...
        // Uses LibreVisa. Does not work.
        //NativeLibrary.addSearchPath(JNA_LIBRARY_NAME, "lib/linux64");
        visaLibName = "lib/linux64/libvisa.so";
        visaLib = (VisaLibrary) Native.loadLibrary("lib/linux64/libvisa.so", VisaLibrary.class);
    }
...
//  }
  ...
  public long openDefaultResourceManager() {
    try {
      ...
      VisaLibrary.ViStatus visaStatus = visaLib.viOpenDefaultRM(pViSession);
  ...
  //      visaStatus = TkVISA64Library.visaLib.viInstallHandler(
  ...
  public long closeResourceManager() {
      try {
        ...
        VisaLibrary.ViStatus visaStatus = visaLib.viClose(new NativeLong(visaResourceManagerHandle));
        statusObject.setStatus(visaStatus);
  ...
  public long getAttribute(int attribute, JVisaReturnString value, long sessionHandle) {
    try {
      ...
      VisaLibrary.ViStatus visaStatus = visaLib.viGetAttribute(
              new NativeLong(visaResourceManagerHandle), 
  ...
  public long setAttribute(int attribute, int value, long sessionHandle) {
    try {
      ...
      VisaLibrary.ViStatus visaStatus = visaLib.viSetAttribute(
