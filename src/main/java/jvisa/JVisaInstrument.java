...
//  }
   ...
   */
  public long sendAndReceive(String command, JVisaReturnString response, int bufferSize) throws JVisaException {
   ...
   * @throws jvisa.JVisaException
   */
  public long sendAndReceive(String command, JVisaReturnString response) throws JVisaException {
